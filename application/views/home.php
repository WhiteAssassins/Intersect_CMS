  ...
  <section class="text-center white-text">
    ...
    <div class="row">
      ...
      <div class="col-md-4 mb-4">
        ...
        <h5 class="font-weight-bold my-4 text-uppercase">PVP</h5>
        <p class="mb-md-0 mb-5">Sistema PVP Con muchas Recompensas para los mejores guerreros del Reino.
        </p>
      ...
      <div class="col-md-4 mb-4">
        ...
        <h5 class="font-weight-bold my-4 text-uppercase">Mascotas</h5>
        <p class="mb-md-0 mb-5">Sistema de Mascotas para PVP y PVE. Estas listo para tener un gato un perro o hasta un dragon porque no?.
        </p>
      ...
      <div class="col-md-4 mb-4">
        ...
        <h5 class="font-weight-bold my-4 text-uppercase">Craftea</h5>
        <p class="mb-0">Crea desde una pocion, armadura hasta una caja de bombones para esa enamorada que tienes por ahi 👌.
        </p>
