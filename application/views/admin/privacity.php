        ...
        <div class="card  cards-novo">
          <div class="card-body">
            <form class="text-center" style="color: #757575;" action="<?php echo base_url('config/changeprivacity'); ?>" method="POST">
              <h3 class="font-weight-bold my-4 pb-2 text-center ">Editar Privacidad</h3>
                <input type="hidden" name="id" value="<?php echo $rest[0]['id']; ?>">
              <textarea id="tiny" name="privacity" placeholder="Texto Privacidad"><?php echo $rest[0]['privacity']; ?></textarea>
